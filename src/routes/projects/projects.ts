...
export const projects: Array<Project> = [
    {
        ...
        keywords: ["C++", "Ncurses", "Entity Component System", "MVC"],
        links: [
            {
                icon: "fa-brands fa-github",
                link: "https://github.com/VincenzoY/age",
            }
        ],
        description: `
    ...
    },
    {
        ...
        keywords: ["Svelte", "SvelteKit", "TypeScript", "JavaScript"],
        links: [
            {
                icon: "fa-brands fa-github",
                link: "https://github.com/VincenzoY/sveltekit_personal_site",
            }
        ],
        description: `
    ...
    },
    {
        ...
        links: [
            {
                icon: "fa-brands fa-github",
                link: "https://github.com/VincenzoY/front_end_portfolio/tree/master/lib/sketchboard",
            },
            {
                icon: "fa-solid fa-arrow-up-right-from-square",
                link: "https://vincenzoy.github.io/front_end_portfolio/lib/sketchboard/sketchboard.html",
            }
        ],
        description: `
    ...
    },
    {
        ...
        keywords: ["Ruby on Rails", "PostgreSQL", "JavaScript", "HTML/CSS/SASS", "DigitalOcean"],
        links: [
            {
                icon: "fa-brands fa-github",
                link: "https://github.com/VincenzoY/personal-site",
            }
        ],
        description: `
    ...
    },
    {
        ...
        keywords: ["Ruby", "SQLite3", "Google Cloud Platform"],
        links: [
            {
                icon: "fa-brands fa-github",
                link: "https://github.com/VincenzoY/timer_bot",
            }
        ],
        description: `
